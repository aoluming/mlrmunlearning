...
# MODEL_ID = '/data2/dmz/multi_Inference_model/R1-Onevision/LLaMA-Factory/saves/r1-onevision-7b-lora-sft-dataGA66-trump_final-gaa-50epochs'
...
MODEL_ID = '/data2/dmz/multi_Inference_model/R1-Onevision/LLaMA-Factory/saves/r1-onevision-7b-lora-sft-dataGA66-trump_final-cocoun-30epochs'
...
# 图片文件夹路径  /data2/dmz/llava_test/LLaVA-main/all_pic/joebiden/recognized /data2/dmz/llava_test/LLaVA-main/imgsdon
image_folder = "/data2/dmz/llava_test/LLaVA-main/all_pic/joebiden/recognized"
image_extensions = {'.jpg', '.jpeg', '.png', '.bmp', '.gif', '.webp', '.tiff'}
